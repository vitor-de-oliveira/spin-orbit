...
int main(int argc, char **argv)
{
	...
	**/
	...
	analysis.convergence_transient_wn = 4e3; 	// 1e4 (moon) 1e3 (hyp - weak) 4e3 (hyp - strong)
	...
	// 	phase_space(system_loop, analysis, rk);
	// 	// draw_phase_space(system_loop, analysis);
	// 	draw_phase_space_clean(system_loop, analysis);
	// }
